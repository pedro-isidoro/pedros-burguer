...
export const MenuAsider = ({closeModal}:MenuAsiderProps) => {
    return (
        <aside className="h-[19rem] w-[10rem] bg-black dark:bg-[#FFCC00] roun flex flex-col items-start justify-center absolute left-0 top-0 py-2 px-4 pb-2 gap-[0.5rem] rounded-ee-lg z-[5] text-white dark:text-black">
            <FaX className="text-2xl hover:text-[#d73bc7d5] mb-2 cursor-pointer" onClick={closeModal}/>
